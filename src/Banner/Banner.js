...
const Banner = () => {
    return (
        <div className='flex flex-col lg:flex-row justify-content-center h-3/4 my-10 lg:pt-24 px-5 md:px-12 lg:px-32'>
            ...
            <div className='banner-left flex-1'>
                ...
                <div className='flex flex-col lg:gap-4'>
                    ...
                    {/* Left side button */}
                    <button className='btn btn-primary w-24 lg:w-48 mt-3'>Meet Our Specialists</button>
